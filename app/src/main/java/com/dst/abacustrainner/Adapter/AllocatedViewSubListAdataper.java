...
public class AllocatedViewSubListAdataper extends RecyclerView.Adapter<AllocatedViewSubListAdataper.MyViewHolder> {

    Context mContext;
    List<AlloactedViewSubTopicListResponse.Result.PracticesList> practicesList;

    public AllocatedViewSubListAdataper(AllocatedViewPracticeActivity viewPracticeListActivity, List<AlloactedViewSubTopicListResponse.Result.PracticesList> result) {
    ...
    @NonNull
    @Override
    public AllocatedViewSubListAdataper.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewallocated_sub_topic_adapter, parent, false);
        return new AllocatedViewSubListAdataper.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllocatedViewSubListAdataper.MyViewHolder holder, int position) {
        ...
        holder.butResult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(mContext, AllocatedViewSubResultDetailsActivity.class);
