...
public class ViewSubListTopicAdapter extends RecyclerView.Adapter<ViewSubListTopicAdapter.MyViewHolder> {

    Context mContext;
    List<ViewSubTopicListResponse.Result.PracticesList> practicesList;

    public ViewSubListTopicAdapter(CoursePracticesActivity viewPracticeListActivity, List<ViewSubTopicListResponse.Result.PracticesList> result) {
    ...
    @NonNull
    @Override
    public ViewSubListTopicAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_sub_topic_adapter, parent, false);
        return new ViewSubListTopicAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewSubListTopicAdapter.MyViewHolder holder, int position) {
        ViewSubTopicListResponse.Result.PracticesList  practices=practicesList.get(position);
        ...
        holder.butResult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(mContext, ViewSubResultDetailsActivity.class);
