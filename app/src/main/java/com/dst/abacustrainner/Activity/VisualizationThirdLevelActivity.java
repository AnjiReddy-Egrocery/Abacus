...
public class VisualizationThirdLevelActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualization_third_level);
...
//        isQuestionAnswered = new ArrayList<>(questions.length);
    ...
    private void readNumbersAloud(String[] numbers) {
        ...
        // After reading individual numbers, read the entire question
    ...
    private void onPreviousButtonClick(View view) {
        ...
        if (currentQuestionIndex >= 0 && currentQuestionIndex < questions.length) {
            ...
            Toast.makeText(VisualizationThirdLevelActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
        }
    ...
    private void onSaveAndNextButtonClick(View view) {
        ...
        if (currentQuestionIndex < questions.length-1) {
            ...
            Toast.makeText(VisualizationThirdLevelActivity.this, "Level is Completed", Toast.LENGTH_SHORT).show();
    ...
    private void showCompletionPopup() {
        ...
        builder.setTitle("Level-3 Completed");
...
//
    ...
    private void ReportMethod() {
        ...
        Intent intent = new Intent(VisualizationThirdLevelActivity.this, VisualizationThirdLevelResultActivity.class);
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(VisualizationThirdLevelActivity.this);
