...
public class LevelVideoResultVisualizationDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_video_result_visualization_details);
