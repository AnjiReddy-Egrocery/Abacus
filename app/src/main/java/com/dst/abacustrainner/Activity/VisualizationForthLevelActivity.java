...
public class VisualizationForthLevelActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualization_forth_level);
        ...
        butSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                stopTimer();  // Stop the timer before saving state
                saveTimerState();
                showCompletionPopup();
            }
        });
...
//        isQuestionAnswered = new ArrayList<>(questions.length);
    ...
    private void onPreviousButtonClick(View view) {
        ...
        if (currentQuestionIndex >= 0 && currentQuestionIndex < questions.length) {
            ...
            Toast.makeText(VisualizationForthLevelActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
        }
       txtTimer.setVisibility(View.VISIBLE);
    }
    ...
    private void onSaveAndNextButtonClick(View view) {
        ...
        if (currentQuestionIndex < questions.length-1) {
            ...
            Toast.makeText(VisualizationForthLevelActivity.this, "Level is Completed", Toast.LENGTH_SHORT).show();
    ...
    private void showCompletionPopup() {
        ...
        builder.setTitle("Level-4 Completed");
...
//
    ...
    private void ReportMethod() {
        ...
        Intent intent = new Intent(VisualizationForthLevelActivity.this, VisualizationForthLevelResultActivity.class);
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(VisualizationForthLevelActivity.this);
