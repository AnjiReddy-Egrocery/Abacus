...
public class InstructorPracticeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instructor_practice_list);
...
//        txtNotAttemtedQuestion.setText(String.valueOf(notAttemptedQuestions));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(InstructorPracticeListActivity.this, HomeActivity.class);
