...
public class InstructorVisualizationResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instructor_visualization_result);
...
//        txtNotAttemtedQuestion.setText(String.valueOf(notAttemptedQuestions));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(InstructorVisualizationResultActivity.this, HomeActivity.class);
