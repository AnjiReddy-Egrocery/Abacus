...
public class AllocatedAssignmentPracticeWorkSheetResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allocated_assignment_practice_work_sheet_result);
...
//        txtNotAttemtedQuestion.setText(String.valueOf(notAttemptedQuestions));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(AllocatedAssignmentPracticeWorkSheetResultActivity.this, HomeActivity.class);
