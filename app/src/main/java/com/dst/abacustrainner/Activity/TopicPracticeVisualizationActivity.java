...
public class TopicPracticeVisualizationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topic_practice_visualization);
 ...
 */
    ...
    private void showCompletionDialog() {
        ...
        AlertDialog.Builder dialog=new AlertDialog.Builder(TopicPracticeVisualizationActivity.this);
    ...
    private void ResultMethod(String examRnm, JSONArray jsonArray) {
        ...
        call.enqueue(new Callback<SubmitDataResponse>() {
            ...
            public void onResponse(Call<SubmitDataResponse> call, Response<SubmitDataResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    /*    Toast.makeText(LevelTopicExamActivity.this,
                        ...
                        Intent intent =
                                new Intent(TopicPracticeVisualizationActivity.this,
                                        TopicVisualizationResultActivity.class);
            ...
            public void onFailure(Call<SubmitDataResponse> call, Throwable t) {
                Toast.makeText(TopicPracticeVisualizationActivity.this, "Submit failed: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
