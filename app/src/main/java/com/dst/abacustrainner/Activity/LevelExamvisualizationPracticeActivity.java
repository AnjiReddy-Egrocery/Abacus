...
public class LevelExamvisualizationPracticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_examvisualization_practice);
...
//    }
    ...
    private void onPreviousButtonClick(View view) {
        ...
        if (currentQuestionIndex > 0) {
            ...
            Toast.makeText(LevelExamvisualizationPracticeActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
        }
    }
...
//
    ...
    private void ReportMethod() {
        ...
        Intent intent = new Intent(LevelExamvisualizationPracticeActivity.this, VisualizationResultActivity.class);
...
/*private void onButtonClicked(int tag) {
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(LevelExamvisualizationPracticeActivity.this);
