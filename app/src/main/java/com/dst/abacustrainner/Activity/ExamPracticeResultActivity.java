...
public class ExamPracticeResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_practice_result);
        ...
        RetakeTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intents =new Intent(ExamPracticeResultActivity.this,LevelExamPracticeActivity.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(ExamPracticeResultActivity.this, HomeActivity.class);
