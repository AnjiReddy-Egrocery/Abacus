...
import com.dst.abacustrainner.Adapter.LevelVideoResultAdapter;
...
public class LevelVideoResultActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<LevelVideoResultModel> resultList = new ArrayList<>();
    LevelVideoResultAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_video_result);
        ...
        adapter = new LevelVideoResultAdapter(this, resultList);
