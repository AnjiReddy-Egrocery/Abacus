...
public class AllocatedPracticeWorkSheetResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allocated_practice_work_sheet_result);
...
//        txtNotAttemtedQuestion.setText(String.valueOf(notAttemptedQuestions));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(AllocatedPracticeWorkSheetResultActivity.this, HomeActivity.class);
