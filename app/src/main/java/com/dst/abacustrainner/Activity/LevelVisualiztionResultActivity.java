...
public class LevelVisualiztionResultActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    ArrayList<LevelResultModel> resultList = new ArrayList<>();
    LevelVisualizationResultAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_visualiztion_result);
        ...
        adapter = new LevelVisualizationResultAdapter(this, resultList);
