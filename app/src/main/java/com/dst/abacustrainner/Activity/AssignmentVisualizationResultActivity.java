...
public class AssignmentVisualizationResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assignment_visualization_result);
...
//        txtNotAttemtedQuestion.setText(String.valueOf(notAttemptedQuestions));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(AssignmentVisualizationResultActivity.this, HomeActivity.class);
        ...
        for (int i = 0; i < questions.size(); i++) {
            ...
            Log.e("Debug", "Index: " + i + ", Entered Answer: " + enteredAnswer + ", Correct Answer: " + correctAnswer);
            if (i<questions.size()){
