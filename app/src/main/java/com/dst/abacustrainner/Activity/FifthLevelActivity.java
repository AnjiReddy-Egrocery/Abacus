...
public class FifthLevelActivity extends AppCompatActivity {
    ...
    private void onPreviousButtonClick(View view) {
        ...
        if (currentQuestionIndex >= 0 && currentQuestionIndex < questions.length) {
            ...
            Toast.makeText(FifthLevelActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
        }
    ...
    private void onSaveAndNextButtonClick(View view) {
        ...
        if (currentQuestionIndex < questions.length-1) {
            ...
            Toast.makeText(FifthLevelActivity.this, "Level is Completed", Toast.LENGTH_SHORT).show();
            showCompletionPopup();
        }
    }
...
//                 //
    ...
    private void showReportActivity() {
        ...
        try {
            ...
            Log.e("FifthLevelactivity", "Formatted JSON Array Contents: " + jsonArray.toString());
    ...
    private void ReportMethod() {
                ...
                Intent intent = new Intent(FifthLevelActivity.this, FifthLevelResultActivity.class);
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(FifthLevelActivity.this);
