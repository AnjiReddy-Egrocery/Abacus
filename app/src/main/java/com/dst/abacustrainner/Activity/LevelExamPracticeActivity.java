...
public class LevelExamPracticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_exam_practice);
...
//            txtDisplayQuestion.setBackgroundColor(ContextCompat.getColor(this, R.color.unansweredButtonColor));
    ...
    private void onPreviousButtonClick(View view) {
        ...
        if (currentQuestionIndex > 0) {
            ...
            Toast.makeText(LevelExamPracticeActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
        }
    }
...
//                        stepButton.setBackgroundColor(getResources().getColor(R.color.answeredButtonColor));
        ...
        if (currentQuestionIndex < questions.length - 1) {
            ...
            Toast.makeText(LevelExamPracticeActivity.this, "Level is Completed", Toast.LENGTH_SHORT).show();
            showCompletionPopup();
        }
    }
...
//
    ...
    private void ReportMethod() {
        Toast.makeText(LevelExamPracticeActivity.this, "All Questions are Submited", Toast.LENGTH_LONG).show();
        ...
        Intent intent = new Intent(LevelExamPracticeActivity.this, ExamPracticeResultActivity.class);
...
//                intent.putStringArrayListExtra("totalTime",txtTotalTimer);
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(LevelExamPracticeActivity.this);
