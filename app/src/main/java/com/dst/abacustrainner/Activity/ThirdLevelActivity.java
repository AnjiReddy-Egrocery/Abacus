...
public class ThirdLevelActivity extends AppCompatActivity {
    ...
    private void onPreviousButtonClick(View view) {
        ...
        saveTimerState();
            ...
            if (currentQuestionIndex >= 0 && currentQuestionIndex < questions.length) {
                ...
                Toast.makeText(ThirdLevelActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
            }
    ...
    private void onSaveAndNextButtonClick(View view) {
        ...
        if (currentQuestionIndex < questions.length-1) {
            ...
            Toast.makeText(ThirdLevelActivity.this, "Level is Completed", Toast.LENGTH_SHORT).show();
            showCompletionPopup();
        }
    }
    ...
    private void ShowReportActivity() {
        ...
        try {
            ...
            Log.e("thirdlevelactivity", "Formatted JSON Array Contents: " + jsonArray.toString());
    ...
    private void ReportMethod() {
        ...
        Intent intent = new Intent(ThirdLevelActivity.this, ThirdLevelResultActivity.class);
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(ThirdLevelActivity.this);
