...
public class LevelTopicExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_topic_exam);
...
// Start the timer
    ...
    private void VerifyMethod(String studentid, String topicid) {
        ...
        Call<AllocatedTopicExamResponse> call =
                apiClient.allocatedtopicExamList(idPart, topicIdPart);

        call.enqueue(new Callback<AllocatedTopicExamResponse>() {
            @Override
            public void onResponse(Call<AllocatedTopicExamResponse> call,
                                   Response<AllocatedTopicExamResponse> response) {
            ...
            public void onFailure(Call<AllocatedTopicExamResponse> call, Throwable t) {
                ...
                Log.e("Reddy","API Error: "+t.getMessage());
    ...
    private void showCompletionDialog() {
        ...
        AlertDialog.Builder dialog=new AlertDialog.Builder(LevelTopicExamActivity.this);
            ...
            public void onResponse(Call<aloocatedWorkSheetSubmitDataResponse> call, Response<aloocatedWorkSheetSubmitDataResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    /*    Toast.makeText(LevelTopicExamActivity.this,
                        ...
                        Intent intent =
                                new Intent(LevelTopicExamActivity.this,
