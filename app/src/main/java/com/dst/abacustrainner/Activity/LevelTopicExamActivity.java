            ...
            public void onResponse(Call<aloocatedWorkSheetSubmitDataResponse> call, Response<aloocatedWorkSheetSubmitDataResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (submitDataResponse != null) {
                        Toast.makeText(LevelTopicExamActivity.this, "All Questions are Submited", Toast.LENGTH_LONG).show();
                        ...
                        Intent intent = new Intent(LevelTopicExamActivity.this, AllocatedPracticeWorkSheetResultActivity.class);
