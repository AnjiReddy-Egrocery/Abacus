...
public class LevelAssignmentExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_assignment_exam);
...
// Start the timer
    ...
    private void displayQuestion(int currentQuestionIndex) {
        if (questionsArray != null && questionsArray.length > currentQuestionIndex) {
            ...
            if (matcher.find()) {
                ...
                Log.d("QuestionDebug", "Final Image URL: " + imageUrl);
    ...
    private void VerifyMethod(String studentid, String topicid) {
        ...
        Call<AllocatedTopicExamResponse> call=apiClient.allocatedassignmentExamList(idPart,topicIdPart);
    ...
    private void showCompletionDialog() {
        ...
        AlertDialog.Builder dialog=new AlertDialog.Builder(LevelAssignmentExamActivity.this);
            ...
            public void onResponse(Call<aloocatedWorkSheetSubmitDataResponse> call, Response<aloocatedWorkSheetSubmitDataResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (submitDataResponse != null) {
                        Toast.makeText(LevelAssignmentExamActivity.this, "All Questions are Submited", Toast.LENGTH_LONG).show();
                        ...
                        Intent intent = new Intent(LevelAssignmentExamActivity.this, AllocatedAssignmentPracticeWorkSheetResultActivity.class);
