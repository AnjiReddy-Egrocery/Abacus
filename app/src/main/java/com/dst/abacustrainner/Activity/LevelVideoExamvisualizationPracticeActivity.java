...
public class LevelVideoExamvisualizationPracticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_video_examvisualization_practice);
...
//    }
    ...
    private void onPreviousButtonClick(View view) {
        ...
        if (currentQuestionIndex > 0) {
            ...
            Toast.makeText(LevelVideoExamvisualizationPracticeActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void onSaveAndNextButtonClick(View view) {
        ...
        if (currentQuestionIndex < questions.length - 1) {
            ...
            Toast.makeText(LevelVideoExamvisualizationPracticeActivity.this, "Level is Completed", Toast.LENGTH_SHORT).show();
            showCompletionPopup();
        }
    }
...
//
    ...
    private void ReportMethod() {
        ...
        Intent intent = new Intent(LevelVideoExamvisualizationPracticeActivity.this, VisualizationVideoResultActivity.class);
...
/*private void onButtonClicked(int tag) {
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(LevelVideoExamvisualizationPracticeActivity.this);
