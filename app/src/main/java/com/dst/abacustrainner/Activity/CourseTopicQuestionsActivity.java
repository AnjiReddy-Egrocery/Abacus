...
import com.dst.abacustrainner.Adapter.CourseQuestionAdapter;
...
public class CourseTopicQuestionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_topic_questions);

        recyclerView = findViewById(R.id.recycler_papers);
        txtTopicName = findViewById(R.id.txt_batch_name);
    ...
    private void generatePdfFromRecyclerView() {
        ...
        view.post(() -> {
            try {
                ...
                Toast.makeText(CourseTopicQuestionsActivity.this, "PDF Downloaded Successfully!", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(CourseTopicQuestionsActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void VerifyMethod(String studentid, String topicId) {
        progressDialog = new ProgressDialog(CourseTopicQuestionsActivity.this);
       ...
       /* HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
        ...
        Call<CourseQuestionsResponse> call=apiClient.courseQuestions(idPart,topicPart);
        call.enqueue(new Callback<CourseQuestionsResponse>() {
            @Override
            public void onResponse(Call<CourseQuestionsResponse> call, Response<CourseQuestionsResponse> response) {
                Log.d("API_TEST", "onResponse called");

                Log.d("API_TEST", "isSuccessful = " + response.isSuccessful());
                Log.d("API_TEST", "code = " + response.code());

                if(progressDialog != null && progressDialog.isShowing()){
                    progressDialog.dismiss();
                }
                CourseQuestionsResponse viewTopicListResponse = response.body();

                if (viewTopicListResponse.getErrorCode().equals("202")) {
                    Log.d("API_TEST", "body not null");

                    Toast.makeText(CourseTopicQuestionsActivity.this, "Invalid Request, no data found for your request", Toast.LENGTH_SHORT).show();
                    ...
                    Log.d("API_TEST", "body is null");
                    String questionsJson =
                            viewTopicListResponse.getResult().getQuestions();
                    ...
                    if (questionsJson.isEmpty()) {
                        ...
                        Type type = new TypeToken<
                                                        List<CourseQuestionsResponse.Result.Questions>
                                                        >(){}.getType();


                        List<CourseQuestionsResponse.Result.Questions> questionList =
                        ...
                        adapter = new CourseQuestionAdapter(
                                CourseTopicQuestionsActivity.this,
                                questionList
                        );
                    ...
                    Toast.makeText(CourseTopicQuestionsActivity.this, "Data Error", Toast.LENGTH_LONG).show();
                    txtNodata.setVisibility(View.VISIBLE); // Show No Data Found TextView
                    recyclerView.setVisibility(View.GONE); // Hide RecyclerView
                }
            }
            ...
            @Override
            public void onFailure(Call<CourseQuestionsResponse> call, Throwable t) {
                Log.d("API_TEST", "API Failed", t);
