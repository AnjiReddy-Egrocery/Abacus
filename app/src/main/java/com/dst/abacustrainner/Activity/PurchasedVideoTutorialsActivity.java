...
public class PurchasedVideoTutorialsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purchased_video_tutorials);
        ...
        if (cartType == null) {
            cartType = "video";  // Default fallback
        }
        ...
        for (Map.Entry<String, List<String>> entry : data.entrySet()) {
            ...
            for (String level : levels) {
                ...
                row.setOnClickListener(v -> {
                    Intent intent = new Intent(PurchasedVideoTutorialsActivity.this, LevelVideotutorialTopicActivity.class);
