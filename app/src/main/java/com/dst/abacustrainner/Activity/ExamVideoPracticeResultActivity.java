...
public class ExamVideoPracticeResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_video_practice_result);
        ...
        RetakeTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intents =new Intent(ExamVideoPracticeResultActivity.this,LevelExamPracticeActivity.class);
        ...
        NextLevel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent intents =new Intent(ExamPracticeResultActivity.this,FirstLevelActivity.class);
                if(levelValue==5){
                    Toast.makeText(ExamPracticeResultActivity.this, "No further level", Toast.LENGTH_SHORT).show();
                }else{
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(ExamVideoPracticeResultActivity.this, HomeActivity.class);
