...
public class ViewResultDetailsActivity extends AppCompatActivity {
    ...
    TextView txtTotalQuestions,dateTime,txtTotalQuestion,txtAttemtedQuestons,txtCorrectAnswers,txtworngAnswers,txtNotAttemted;
...
//            txtStartDate.setText(startDate);
                    ...
                    List<ViewTopicResultResponse.Question> questionsList = result.getQuestionsList();
                    // Initialize counters
                    ...
                    for (int i = 0; i < questionsList.size(); i++) {
                        ViewTopicResultResponse.Question questionObj = questionsList.get(i);
