...
public class LevelAssignmentVisualizationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_assignment_visualization);
...
*/
    ...
    private void showCompletionDialog() {
        ...
        AlertDialog.Builder dialog=new AlertDialog.Builder(LevelAssignmentVisualizationActivity.this);
