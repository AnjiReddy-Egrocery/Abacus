...
public class AllocatedViewPracticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allocated_view_practice);
        ...
        LinearLayoutManager layoutManager=new LinearLayoutManager(AllocatedViewPracticeActivity.this);
    ...
    private void VerifyMethod(String studentid, String topicid) {
        ...
        Call<AlloactedViewSubTopicListResponse> call = apiClient.getAllocatedSubViewListPractice(idPart,topicPart);
        call.enqueue(new Callback<AlloactedViewSubTopicListResponse>() {
            ...
            public void onResponse(Call<AlloactedViewSubTopicListResponse> call, Response<AlloactedViewSubTopicListResponse> response) {
                ...
                if (viewTopicListResponse.getErrorCode().equals("202")) {
                    Toast.makeText(AllocatedViewPracticeActivity.this, "Invalid Request, no data found for your request", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AllocatedViewPracticeActivity.this, "Data Error", Toast.LENGTH_LONG).show();
