...
public class ForthLevelActivity extends AppCompatActivity {
    ...
    private void onPreviousButtonClick(View view) {
        ...
        if (currentQuestionIndex >= 0 && currentQuestionIndex < questions.length) {
            ...
            Toast.makeText(ForthLevelActivity.this, "No previous questions available", Toast.LENGTH_SHORT).show();
        }
    ...
    private void onSaveAndNextButtonClick(View view) {
        ...
        if (currentQuestionIndex < questions.length-1) {
            ...
            Toast.makeText(ForthLevelActivity.this, "Level is Completed", Toast.LENGTH_SHORT).show();
            showCompletionPopup();
        }
    }
    ...
    private void showreportactivity() {
        ...
        try {
            ...
            Log.e("ForthlevelActivity", "Formatted JSON Array Contents: " + jsonArray.toString());
    ...
    private void ReportMethod() {
                ...
                Intent intent = new Intent(ForthLevelActivity.this, ForthLevelResultActivity.class);
    ...
    private void showExitConfirmationDialog() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(ForthLevelActivity.this);
