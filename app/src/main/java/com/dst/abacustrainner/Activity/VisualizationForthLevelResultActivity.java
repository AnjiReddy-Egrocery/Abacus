...
public class VisualizationForthLevelResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualization_forth_level_result);
        ...
        Log.e("ResultActivity", "isQuestionAttempted: " + isQuestionAttempted.toString());
        Log.e("ResultActivity", "isQuestionCorrect: " + isQuestionCorrect.toString());
        ...
        Log.e("Debug", "Size of questions list: " + questions.size());
        Log.e("Debug", "Size of enteredAnswers list: " + enteredAnswers.size());
